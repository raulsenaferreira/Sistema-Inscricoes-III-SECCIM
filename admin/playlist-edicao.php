...
<tr>
	...
	<!-- start id-form -->
	<form action="playlist-edicao.php?id=<?=$_GET['id']?>" method="post" enctype="multipart/form-data">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top">Título:</th>
			<td><input type="text" class="inp-form" name="nome" value="<?=$playlist->getNome()?>"/></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Ordem:</th>
			<td><input type="text" class="inp-form" name="ordem" value="<?=$playlist->getOrdem()?>"/></td>
			<td></td>
		</tr>
		<tr>
			<th>Arquivo:</th>
			<td><input type="file" class="file_1" name="arquivo"/></td>
			<td>
				<div class="bubble-left" style="margin-left:90px;"></div>
				<div class="bubble-inner">mp3, ogg, 10MB max</div>
				<div class="bubble-right"></div>
			</td>
			<td>
			<?php
				 $nomeArquivo = md5($playlist->getId());
				 
				 $url = Config::IMGADMIN."playlist/".$nomeArquivo.$playlist->getExtensao();
			?>	
				<br />
			</td>
		</tr>
