...
<tr>
	...
	<td>
		...
		if($_POST['send'] == 'sended'){
			...
			if($playlist->cadastrar($dados)){
				...
				$lastId = Playlist::getLastId();
				
				redirect('playlist-edicao.php?id='.$lastId, 1);
				exit();
	...
	<!-- start id-form -->
	<form action="playlist-cadastro.php" method="post" enctype="multipart/form-data">
