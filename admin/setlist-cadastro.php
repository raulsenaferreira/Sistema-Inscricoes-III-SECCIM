...
<tr>
	...
	<td>
		...
		if($_POST['send'] == 'sended'){
			...
			if($setlist->cadastrar($dados)){
				...
				$lastId = Setlist::getLastId();
				
				redirect('setlist-edicao.php?id='.$lastId, 1);
				exit();
	...
	<!-- start id-form -->
	<form action="setlist-cadastro.php" method="post" enctype="multipart/form-data">
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="url_play" value=""/></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Url Download:</th>
			<td><input type="text" class="inp-form" name="url_download" value=""/></td>
			<td></td>
		</tr>
		<tr>
			<th>&nbsp;</th>
