...
<tr>
	...
	<td>
		...
		if($_POST['send'] == 'sended'){
			...
			if($usuario->cadastrar($dados)){
				...
				redirect('usuario-edicao.php?id='.$lastId, 1);
				exit();
	...
	<!-- start id-form -->
	<form action="usuario-cadastro.php" method="post" enctype="multipart/form-data">
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="email" value="<?=$_POST['email']?>"/></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Senha:</th>
			<td><input type="password" class="inp-form" name="senha" value="<?=$_POST['senha']?>"/></td>
			<td></td>
		</tr>
		<tr>
		<tr>
