...
<tr>
	...
	<form action="agenda-cadastro.php" method="post" enctype="multipart/form-data">
		...
		<tr>
			...
			<td colspan="2"><textarea name="texto" style="width:97%;height:150px;" maxlength="180"><?=$_POST['texto']?></textarea><br /><br /> Máximo de 180 Caracteres</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="url" value="<?=$_POST['url']?>" maxlength="255"/></td>
			<td></td>
		</tr>
		<tr>
			<th>&nbsp;</th>
